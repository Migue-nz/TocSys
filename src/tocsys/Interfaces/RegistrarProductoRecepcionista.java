...
public void actualizarTablaCombinada() {
 ...
 public void eliminarProductos(int idProducto) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnModificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 370, -1, -1));
        ...
        getContentPane().add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 370, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 60, 690, 300));
